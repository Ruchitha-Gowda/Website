    ...
    return (
        ...
        <div className="container my-5">
            ...
            <section className="mt-4">
                ...
                <div className="row">
                    <Learning title="Web Dev" desc="HTML, CSS, JS, React"/>
                    <Learning title="Data Structure" desc="Arrays, Trees, Graphs"/>
                    <Learning title="Cyber Security" desc="OWASP, Crytography"/>
                </div>
            </section>
